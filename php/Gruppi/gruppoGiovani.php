...
<html lang="it">
    ...
    <div id="container">
        <header>
        <img class="imgXg" src="./../../css/Immagini/Gruppi/gGiovani.jpeg" alt="Sfondo">

            <h3 id="Gruppo">Gruppo giovani</h3>
        </header>
        <div id="movePage">
            ...
            <div class="menu" id="menu3" onmouseenter="selezioneSi(id)" onmouseleave="selezioneNo(id)" onclick="go(id)">
                ...
                <img id="imgMenu3" src="./../../css/Immagini/Icone/info.png" alt="imgHome">
            </div>
